...
window.onload= function(){
	showReviewMessage(${userRecipeList});
};


</script>

<p class ="userProfile" style="padding-left:25px; font-size:25px;">My Reviews</p>
<div class="container3">
<!-- 			<div class="header">
				<a class="recipeHeads">Top Rated</a>
			</div> -->
			<div class="recipeMatrix" id="userReviewSection">
				...
				<div id="noReviews">
				Sorry. There are no user added reviews.
				</div>
