...
<body onload='document.f.j_username.focus();'>
	...
	<div class="RegisterGallery">
		...
		<div class="form" style="top: 150px; right: 180px">
			...
			<form action="validateSecurity" method="POST">
				
			        <p>${existingUser.securityQ1}</p>
						<input type="text" name="answer1" placeholder="Please Enter Your Answer">
					<p>${existingUser.securityQ2}</p>
						<input type="text" name="answer2" placeholder="Please Enter Your Answer">
					<p>${existingUser.securityQ3}</p>
						<input type="text" name="answer3" placeholder="Please Enter Your Answer">
						
						<input type="hidden" name="username" value="${existingUser.username}">
