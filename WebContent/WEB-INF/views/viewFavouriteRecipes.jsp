...
window.onload= function(){
	showFavouriteRecipeMessage(${userRecipeList});
};


</script>

<p class ="userProfile" style="padding-left:25px; font-size:25px;">My Favourites</p>
<div class="container3">
			...
			<div class="recipeMatrix">
				...
				<div id="noRecipes">
				Sorry. There are no user added favourite recipes.
				</div>
