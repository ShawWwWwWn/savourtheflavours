	...
	<div class="RegisterGallery">
		...
		<div class="form" style="top: 150px; right: 180px">
			...
			<form action="resetUserPassword" method="POST">
						...
						<input type="password" name="newPassword" placeholder="Please Enter Your New Password">
						<input type="password" name="newPasswordRepeat" placeholder="Please Confirm Your Password">
